    ...
    <>
      <div className="it  relative bg-[url('http://wpdemo.archiwp.com/engitech/wp-content/uploads/sites/4/2019/12/bg-pheader.jpg')] ">
        <div className="flex p-8">
          <section>
            <header className="my-20 text-6xl font-bold text-white">
              IT Services
            </header>
          </section>
        </div>
      ...
      <div className="ml-10 grid gap-10 p-4 md:grid-cols-1 lg:grid-cols-3">
        <section className="flex rounded-md border-2 border-transparent p-1 hover:border-black">
          ...
          <div className="ml-4">
            ...
            <p>
              Chúng tôi có nhiều kĩ năng hơn là chỉ có kỹ năng code tốt. Kinh
              nghiệm của chúng tôi khiến chúng tôi nổi bật so với các công ty
              phát triển web khác.
            </p>
          </div>
        </section>
        <section className="flex rounded-md border-2 border-transparent p-1 hover:border-black">
          ...
          <div className="ml-4">
            ...
            <p>
              Tạo phần mềm doanh nghiệp phức tạp, đảm bảo tích hợp phần mềm đáng
              tin cậy, hiện đại hóa hệ thống cũ của bạn.
            </p>
          </div>
        </section>
        <section className="flex rounded-md border-2 border-transparent p-1 hover:border-black">
          ...
          <div className="ml-4">
            ...
            <p>
              Xây dựng sản phẩm bạn cần đúng thời hạn với đội ngũ giàu kinh
              nghiệm sử dụng quy trình thiết kế rõ ràng và hiệu quả.
            </p>
          </div>
        </section>
        <section className="flex rounded-md border-2 border-transparent p-1 hover:border-black">
          ...
          <div className="ml-4">
            ...
            <p>
              Liên hệ với các chuyên gia của chúng tôi để thực hiện kiểm tra và
              kiểm tra phần mềm của bạn một cách toàn diện, nhiều giai đoạn.
            </p>
          </div>
        </section>
        <section className="flex rounded-md border-2 border-transparent p-1 hover:border-black">
          ...
          <div className="ml-4">
            ...
            <p>
              Hãy tin tưởng vào những bộ óc hàng đầu của chúng tôi để loại bỏ
              các điểm yếu trong quy trình làm việc, triển khai công nghệ mới và
              hợp nhất các danh mục ứng dụng.
            </p>
          </div>
        </section>
        <section className="flex rounded-md border-2 border-transparent p-1 hover:border-black">
          ...
          <div className="ml-4">
            ...
            <p>
              Trong thập kỷ qua, khách hàng của chúng tôi thành công bằng cách
              tận dụng quá trình xây dựng, dựa trên Intellectsoft.
            </p>
          </div>
        </section>
      </div>
      ...
      <div className="m-10 mt-60">
        ...
        <p className="my-4 font-thin text-gray-500">
          Chúng tôi giúp các doanh nghiệp nâng cao giá trị của họ thông qua phát
          triển phần mềm tùy chỉnh, thiết kế sản phẩm, QA và các dịch vụ tư vấn.
        </p>
      </div>
