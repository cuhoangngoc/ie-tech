      ...
      <div className="container mx-auto px-2 md:px-4">
        ...
        <div className="ml-10 grid gap-10 p-4 md:grid-cols-1 lg:grid-cols-3">
          ...
          <section className="flex rounded-md border-2 border-transparent p-1 hover:border-black">
            ...
            <div className="ml-4">
              ...
              <p>
                Tạo phần mềm doanh nghiệp phức tạp, đảm bảo tích hợp phần mềm
                đáng tin cậy, hiện đại hóa hệ thống cũ của bạn.
              </p>
            </div>
          </section>
          <section className="flex rounded-md border-2 border-transparent p-1 hover:border-black">
          ...
          <section className="flex rounded-md border-2 border-transparent p-1 hover:border-black">
            ...
            <div className="ml-4">
              ...
              <p>
                Liên hệ với các chuyên gia của chúng tôi để thực hiện kiểm tra
                và kiểm tra phần mềm của bạn một cách toàn diện, nhiều giai
                đoạn.
              </p>
            </div>
          </section>
          <section className="flex rounded-md border-2 border-transparent p-1 hover:border-black">
            ...
            <div className="ml-4">
              ...
              <p>
                ...
                các điểm yếu trong quy trình làm việc, triển khai công nghệ mới
                và hợp nhất các danh mục ứng dụng.
              </p>
            </div>
          </section>
          <section className="flex rounded-md border-2 border-transparent p-1 hover:border-black">
        ...
        <div className="m-10 mt-60">
          ...
          <p className="my-4 font-thin text-gray-500">
            Chúng tôi giúp các doanh nghiệp nâng cao giá trị của họ thông qua
            phát triển phần mềm tùy chỉnh, thiết kế sản phẩm, QA và các dịch vụ
            tư vấn.
          </p>
        </div>
