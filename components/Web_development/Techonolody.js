    ...
    <div className='w-full '>
        <div className='grid sm:grid-cols-2 '>
            <div className='flex flex-col bg-[#211e3b] p-8'>
                <p className='uppercase text-[8E88B8] py-2'></p>
                <h1 className='text-[#ffff] text-lg font-bold text-[40px] py-2 my-4'>We Organize Our Production Process</h1>
                ...
                their value through custom software development, product design, QA and consultancy services. Our product design service lets you prototype, test and validate your ideas.</p>
            ...
            <div>
                ...
                <ReactPlayer url='https://www.youtube.com/watch?v=wWgIAphfn2U' width='full' height='550px' playing={true} controls={true}/>
            </div>
